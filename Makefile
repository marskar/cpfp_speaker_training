...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"cpfp_speaker_training","description":"Training for the CPFP Fellows Research Meeting"}'
	test -f README.rst || echo "CPFP Speaker Training" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/cpfp_speaker_training.git
